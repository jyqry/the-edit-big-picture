  ...
  <div class="hello" v-if="pages">
    ...
    >
      <div class="watermark" v-bind:class="page.theme.watermark">
        <img
          src="/static/water_gray.png"
          v-if="page.theme.watermark === 'gray'"
        />
        <img
          src="/static/water_white.png"
          v-if="page.theme.watermark === 'white'"
        />
      </div>
      <div
        v-bind:style="{
      ...
      >
        <div
          ...
          :key="index"
          v-bind:class="page.theme.device"
          v-bind:style="{
...
export default {
      ...
      if (files) {
        for (let i = 0; i < files.length; i++) {
          ...
          reader.onloadend = e => {
            this.$store.dispatch(
              "addImage",
              this.dataURItoBlob(e.target.result)
            );
          };
  ...
  computed: {
    ...
    ...mapGetters(["pages", "currentPage", "album"])
  }
};
</script>
  ...
  .device {
    ...
    &.apple-iphone-12-pro {
      ...
      .mock {
        ...
        height: 890px;
        position: absolute;
        background-image: url("/static/mockup/apple-iphone-12-pro.png");
